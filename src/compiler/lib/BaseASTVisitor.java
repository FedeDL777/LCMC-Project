...
public class BaseASTVisitor<S,E extends Exception> {
	...
	//Method for new nodes
	public S visitNode(MinEqualNode n) throws E {throw new UnimplException();}

	public S visitNode(MagEqualNode n) throws E {throw new UnimplException();}
	...
	public S visitNode(MethodCallNode n) throws E {throw new UnimplException(); }
