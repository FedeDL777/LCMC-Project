...
public interface FOOLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code min_eq}
	 * labeled alternative in {@link FOOLParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMin_eq(FOOLParser.Min_eqContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDiv(FOOLParser.DivContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code mag_eq}
	 * labeled alternative in {@link FOOLParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMag_eq(FOOLParser.Mag_eqContext ctx);
	/**
