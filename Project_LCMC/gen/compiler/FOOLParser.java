...
public class FOOLParser extends Parser {
	...
	public static final int
		...
		COLON=10, COMMA=11, EQ=12, ASS=13, MIN_EQ=14, MAG_EQ=15, NOT=16, AND=17, 
		OR=18, TRUE=19, FALSE=20, IF=21, THEN=22, ELSE=23, PRINT=24, LET=25, IN=26, 
		VAR=27, FUN=28, INT=29, BOOL=30, NUM=31, ID=32, WHITESP=33, COMMENT=34, 
		ERR=35;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SEMIC", "COLON", "COMMA", "EQ", "ASS", "MIN_EQ", "MAG_EQ", "NOT", "AND", 
			"OR", "TRUE", "FALSE", "IF", "THEN", "ELSE", "PRINT", "LET", "IN", "VAR", 
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Min_eqContext extends ExpContext {
		public List<ExpContext> exp() {
			return getRuleContexts(ExpContext.class);
		}
		public ExpContext exp(int i) {
		...
		public TerminalNode MIN_EQ() { return getToken(FOOLParser.MIN_EQ, 0); }
		public Min_eqContext(ExpContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).enterMin_eq(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).exitMin_eq(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitMin_eq(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Mag_eqContext extends ExpContext {
		public List<ExpContext> exp() {
			return getRuleContexts(ExpContext.class);
		}
		public ExpContext exp(int i) {
		...
		public TerminalNode MAG_EQ() { return getToken(FOOLParser.MAG_EQ, 0); }
		public Mag_eqContext(ExpContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).enterMag_eq(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).exitMag_eq(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitMag_eq(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6462963748L) != 0)) {
					{
					setState(103);
					exp(0);
					setState(108);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 6:
						{
						_localctx = new Min_eqContext(new ExpContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_exp);
						setState(131);
					...
					case 7:
						{
						_localctx = new Mag_eqContext(new ExpContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_exp);
						setState(134);
